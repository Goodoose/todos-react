...
function (_React$Component) {
  ...
  function App() {
    ...
    _this.handlerChangeTodo = _this.handlerChangeTodo.bind(_assertThisInitialized(_this));
    _this.handlerChangeImage = _this.handlerChangeImage.bind(_assertThisInitialized(_this));
    _this.handlerChangeDelete = _this.handlerChangeDelete.bind(_assertThisInitialized(_this));
    _this.buttonAll = _this.buttonAll.bind(_assertThisInitialized(_this));
    _this.buttonActive = _this.buttonActive.bind(_assertThisInitialized(_this));
    _this.buttonCompleted = _this.buttonCompleted.bind(_assertThisInitialized(_this));
    _this.buttonClearCompleted = _this.buttonClearCompleted.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(App, [{
    key: "handlerChange",
    value: function handlerChange(newTodo) {
      if (newTodo === 'ENTER') {
    ...
    key: "handlerChangeTodo",
    value: function handlerChangeTodo(newTodo, id) {
    ...
    key: "handlerChangeDelete",
    value: function handlerChangeDelete(id) {
    ...
    key: "buttonAll",
    value: function buttonAll() {
      this.setState(function (_ref3) {
        var todosTemp = _ref3.todosTemp;
        return {
          todos: todosTemp
        };
      });
    ...
    key: "buttonCompleted",
    value: function buttonCompleted() {
    ...
    key: "buttonClearCompleted",
    value: function buttonClearCompleted() {
      ...
      return todos.map(function (todo, index) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
          ...
          onClick: function onClick() {
            return _this2.handlerChangeImage(index);
          }
          ...
          onChange: function onChange(event) {
            return _this2.handlerChangeTodo(event.target.value, index);
          }
        }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
          href: "#",
          className: "container__image--hide",
          onClick: function onClick() {
            return _this2.handlerChangeDelete(index);
          }
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
          alt: "close",
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          todosTemp = _this$state.todosTemp,
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        onKeyDown: function onKeyDown(event) {
          return event.key === 'Enter' && _this3.handlerChange('ENTER') && event.preventDefault();
        },
        onChange: function onChange(event) {
          return _this3.handlerChange(event.target.value);
        }
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
        className: "container_list"
      }, todosRender), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", {
        className: "container__line"
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "container__footer"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "container__counter"
      }, counterItems, ' ', counterItems === 1 ? 'item left' : 'items left'), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "container__buttons--list"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
        name: "All",
        className: "container__button",
        onClick: function onClick() {
          return _this3.buttonAll();
        }
      }, "All"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
        className: "container__button",
        onClick: function onClick() {
          return _this3.buttonActive();
        }
      }, "Active"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
        className: "container__button",
        onClick: function onClick() {
          return _this3.buttonCompleted();
        }
      }, "Completed")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "container__button--completed"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
        className: "container__button",
        onClick: function onClick() {
          return _this3.buttonClearCompleted();
        }
      }, "Clear completed")))));
    }
  }]);
...
// Module
exports.push([module.i, "* {\n  margin: 0;\n  padding: 0; }\n\nbody {\n  background-color: whitesmoke; }\n\n.headline {\n  display: flex;\n  justify-content: center;\n  color: #ead7d7;\n  font-family: sans-serif;\n  font-size: 16vh; }\n\n.container {\n  width: 550px;\n  margin: 0px auto;\n  border: 1px solid grey;\n  border-radius: 3px;\n  background-color: white;\n  box-shadow: 1px 3px 2px 2px rgba(0, 0, 0, 0.3); }\n\n.container__input {\n  width: 450px;\n  height: 25px;\n  margin-left: 50px;\n  margin-top: 20px;\n  font-family: sans-serif;\n  font-size: 3vh;\n  border: 0;\n  outline: 0;\n  cursor: pointer; }\n\n.container__item {\n  list-style: none;\n  margin: auto; }\n\n.container__content {\n  display: flex;\n  justify-content: baseline; }\n\n.container__content:hover > .container__image--hide {\n  visibility: visible; }\n\n.container__input--item {\n  width: 440px;\n  height: 25px;\n  margin-left: 10px;\n  margin-top: 7px;\n  font-family: sans-serif;\n  font-size: 3vh;\n  border: 0;\n  outline: 0;\n  cursor: pointer; }\n\n.container__image--checked {\n  width: 40px; }\n\n.container__image--hide {\n  visibility: hidden; }\n\n.container__image--close {\n  width: 30px;\n  margin-top: 5px; }\n\n.container__line {\n  height: 1px;\n  margin: auto;\n  margin-top: 8px;\n  margin-bottom: 10px;\n  border: none;\n  color: lightgray;\n  background-color: lightgray; }\n\n.container__footer {\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  margin: 5px; }\n\n.container__counter {\n  justify-content: start;\n  padding: 5px;\n  font-family: sans-serif;\n  font-size: 2.2vh; }\n\n.container__buttons--list {\n  display: flex;\n  justify-content: space-between; }\n\n.container__button--completed {\n  display: flex;\n  justify-content: flex-end; }\n\n.container__button {\n  background: white;\n  border: 1px solid white;\n  border-radius: 2px;\n  padding: 3px;\n  font-family: sans-serif;\n  font-size: 2.2vh;\n  outline: 0;\n  cursor: pointer; }\n\n.container__button--active {\n  border: 1px solid lightgray; }\n\n.container__button:hover {\n  border: 1px solid lightgray; }\n\n.container__button--active {\n  border: 1px solid grey; }\n", ""]);
